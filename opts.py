...
parser.add_argument('--modality', type=str, choices=['Lite', 'RGB', 'PA', 'Flow'])
...
parser.add_argument('--base', default='TSM', type=str, choices=['TSN', 'TSM'])
...
parser.add_argument('--VAP', default=True, action="store_true", help='use VAP for various-timescale aggregation')
