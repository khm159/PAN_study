...
def main():
    ...
    print('- save name: ' + args.store_name)
    ...
    print("-"*30)
    print("Current Running Environment:")
    print("- Python: {}".format(sys.version))
    print("- PyTorch: {}".format(torch.__version__))
    print("- TorchVison: {}".format(torchvision.__version__))
    print("device ids : ", args.gpus)
    print("cuda available : ", torch.cuda.is_available())
    print("GPU name : ", torch.cuda.get_device_name(args.gpus[0]))
    ...
    if args.resume:
        ...
        if os.path.isfile(args.resume):
            print(("=> Checkpoint loading '{}'".format(args.resume)))
            ...
            print(("=> '{}' can't fine checkpoints".format(args.resume)))

    if args.tune_from:
        print(("=> '{}' fine-tune from ".format(args.tune_from)))
