...
def return_ucf101(modality):
    ...
    if modality in ['RGB', 'PA', 'Lite']:
        root_data = ROOT_DATASET + 'UCF101/rgb/'
        filename_imglist_train = 'ucf_list/split1_train_UCF101.txt'
        filename_imglist_val = 'ucf_list/split1_test_UCF101.txt'
        prefix = 'frame{:06d}.jpg'
    elif modality == 'Flow':
        root_data = ROOT_DATASET + 'UCF101/jpg'
        filename_imglist_train = 'UCF101/file_list/ucf101_flow_train_split_1_UCF101.txt'
        filename_imglist_val = 'UCF101/file_list/ucf101_flow_val_split_1_UCF101.txt'
        prefix = 'frame_{}_{:06d}.jpg'
    else:
...
def ETRI_Activity3D(modality):
    ...
    if modality in ['RGB']: 
        root_data = ROOT_DATASET + 'ETRI_Activity3D'
        filename_imglist_train = '~/ETRI_Activity3D_list/train.txt'
        filename_imglist_val = '~/ETRI_Activity3D_list/test.txt'
        prefix = 'frame_{:06d}.jpg'
    else:
        raise NotImplementedError('no such modality:' + modality)
    return filename_categories, filename_imglist_train, filename_imglist_val, root_data, prefix
